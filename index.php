...
BEM
    Block ~ main-menu
    Elelement(__) ~ main-menu__logo, main-menu__left, main-menu__right
    Modifier (--) ~ main-menu__left--open
-->
    <div class="top-nav">
      <div class="main-menu">
    ...
    <main>
        ...
        <div class="content">
          ...
          $entries = [
            ...
            [
              'name' => 'Rihards',
              'image_path' => 'https://images.unsplash.com/photo-1632877558001-92e30f4a6b65?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=2071&q=80'
            ],
